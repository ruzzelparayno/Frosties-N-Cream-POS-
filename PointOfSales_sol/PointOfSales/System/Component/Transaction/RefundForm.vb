...
Public Class RefundForm
    ...
    Private Sub BtnSave_Click(sender As Object, e As EventArgs) Handles BtnSave.Click
        ...
        Dim confirmForm As New RefundConfirmation()
        If confirmForm.ShowDialog() <> DialogResult.OK Then Return

        ' --- Confirm refund action ---
        Dim confirm As DialogResult = MessageBox.Show("Are you sure you want to refund this transaction?",
                                         "Confirm Refund",
        ...
        ' --- Parse subtotal, gross sale, discount ---
        Dim subtotal, grossSaleAmount, discountAmount As Decimal
        ...
        discountAmount = Math.Max(0D, grossSaleAmount - subtotal)
        ...
        ' --- Update shift totals for refund WITHOUT touching discount ---
        cashForm.UpdateShiftSales(refundValue:=0, discountValue:=0, grossSaleValue:=0)

        ' --- Add refund to cumulative total ---
        cashForm.AddRefund(refundAmount)

        ' --- Success message ---
        MessageBox.Show("Refund is successful!", "Refund", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub SiticoneButton3_Click(sender As Object, e As EventArgs) Handles SiticoneButton3.Click
        ...
        receipt.AppendLine()
        receipt.AppendLine()
        receipt.Append(Chr(&H1D) & "V" & Chr(0))
